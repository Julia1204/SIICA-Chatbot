    ...
    return (
        <div style={outer}>
            <div style={container} ref={testAreaRef}>
                ...
                <h1 style={{ color: selectedColorScheme.titleColor, fontSize: '4rem', margin: '2rem 0 1rem' }}>
                    {selectedLanguage.pickYourTestType}
                </h1>

                <p style={{ maxWidth: '600px', margin: '1rem auto', lineHeight: 1.5 }}>
                    <strong>{selectedLanguage.multitaskingMode}</strong> {selectedLanguage.multitaskingModeExplanation}
                    <br />
